...
// TODO: expand to InApp properties
@JS()
@anonymous
class TCData {
...
extension TCDataExt on TCData {
  ...
  Map<String, dynamic> toInAppTCDataMap() {
    return <String, dynamic>{
      ...
      if (publisher != null) ...<String, dynamic>{
...
/// Transparency and consent data for the publisher, which is embedding a CMP
/// SDK.
@JS()
@anonymous
...
void addEventListener(TCDataListener listener) {
  __tcfapi('addEventListener', 2, allowInterop(listener));
}
